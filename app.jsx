...
const SIMULATED_FRAMES = [
  ...
  { time: "00:20", location: "Perimeter", description: "Frame 5: Motion detected along east perimeter fence. Appears to be a small animal." },
...
export default function DroneSecurityDashboard() {
  ...
  const [currentTelemetry, setCurrentTelemetry] = useState(TELEMETRY_DATA[0]);
  ...
  const telemetryMapRef = useRef({});
  const chatInputRef = useRef(null);

  useEffect(() => {
    TELEMETRY_DATA.forEach(t => { telemetryMapRef.current[t.time] = t; });
  }, []);
